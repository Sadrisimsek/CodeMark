...
import NavFoto from "../images/tomya-logo.svg";
  ...
  return (
    <div className="header">
      <div className="container position-relative">
            ...
            <ul className="list-unstyled mb-0  d-flex">
              <li className="dropdown">
                <a href="#" role="button" aria-expanded="true">
                  Kripto Paralar <FontAwesomeIcon icon={faAngleDown} />{" "}
                </a>
                  ...
                  <div className="row dropdown-menu-items">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        >
                          <path
                            fill="#5952E4"
                            fillRule="evenodd"
                            d="M17 0c9.389 0 17 7.611 17 17s-7.611 17-17 17S0 26.389 0 17 7.611 0 17 0zM8 20l8 11v-6.447L8 20zm17 0l-8 4.553V31l8-11zm-9-6l-8 3.423L16 22v-8zm1 0v8l8-4.575L17 14zM16 3L8 16l8-3.39V3zm1 0v9.577L25 16 17 3z"
                          ></path>
                        </svg>
                    ...
                    <div className="col-xl-2 col-lg-2">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">
                          Chainlink
                        </div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Polkadot</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Dogecoin</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Cardano</div>
                      </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">NEO</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Chiliz</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                    ...
                    <div className="col-xl-4 col-lg-4 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Solana</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Polygon</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                    ...
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">PAX Gold</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">ApeCoin</div>
                      </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Cosmos</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Uniswap</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">Fantom</div>
                      </div>
                    </div>
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                    ...
                    <div className="col-xl-2 col-lg-2 mt-1">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="dropdown-item-title ms-2">VeChain</div>
                      </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 mt-1">
                      <div className="d-flex align-items-center">
              ...
              <li>
                <a href="https://pro.tomya.com/" target="_blank">
                  Market
                </a>
              </li>
              <li>
          ...
          <div className="mobile-menu-display">
            ...
            >
              <div className="offcanvas-header justify-content-end">
                <button
                  type="button"
                  className="btn-close btn-close-custom d-flex align-items-center justify-content-center"
              ...
              <div className="offcanvas-body">
                <div className="mobile-menu-items">
                  <div className="menu-item">Kripto Paralar</div>
                  <div className="menu-item">Market</div>
                  <div className="menu-item">Komisyonlar</div>
                  <div className="menu-item">Hakkımızda</div>
                  <div className="menu-item">Basında Biz</div>
                  <div className="menu-item">Duyurular</div>
                  <div className="menu-item">İletişim</div>
        ...
        <div className="cardano  justify-content-end d-flex align-items-center header-notification mt-2">
          <span className="me-3 navbar-text">
            <FontAwesomeIcon icon={faBell} style={{ color: "#ffffff" }} />{" "}
            Cardano Yatırma ve Çekme İşlemleri
          </span>
          <a
            href="https://www.tomya.com/duyurular"
            className="navbar-text navbar-devaminiOku"
          >
            Devamını Oku <FontAwesomeIcon icon={faAnglesRight} />
          </a>
        </div>
      </div>
    </div>
